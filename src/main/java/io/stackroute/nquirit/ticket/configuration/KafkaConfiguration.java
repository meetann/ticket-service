package io.stackroute.nquirit.ticket.configuration;
...
public class KafkaConfiguration {
    ...
    public ProducerFactory<String, Ticket> producerFactory(){
        System.out.println("IS THIS CONFIG GETTING LOADED ????");
    ...
    public KafkaTemplate<String,Ticket> kafkaTemplate(){
        return new KafkaTemplate<String,Ticket>(producerFactory());
    }
}
